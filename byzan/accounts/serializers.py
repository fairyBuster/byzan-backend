...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        first_name = attrs.get('first_name', getattr(self.instance, 'first_name', '') if self.instance else '')
        last_name = attrs.get('last_name', getattr(self.instance, 'last_name', '') if self.instance else '')
