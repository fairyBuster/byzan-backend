...
from .views import (
    ...
    BuyCourseView, BuyCourseWithBalanceView, BuyCourseMidtransInitView, MarkLessonDoneView,
    MyTransactionView, MyCoursesView, MyLessonsView, CourseCertificateView,
...
urlpatterns = [
    ...
    path('<int:course_id>/comments/', CourseCommentListCreateView.as_view(), name='course-comments'),
    path('<int:course_id>/certificate/', CourseCertificateView.as_view(), name='course-certificate'),
    ...
    path('lessons/questions/<int:question_id>/answer/', LessonQuestionAnswerView.as_view(), name='lesson-question-answer'),
    path('my/',                MyCoursesView.as_view(),     name='my-courses'),
    path('my/lessons/',        MyLessonsView.as_view(),     name='my-lessons'),
    path('my/lessons/<int:course_id>/', MyLessonsView.as_view(), name='my-lessons-by-course'),
