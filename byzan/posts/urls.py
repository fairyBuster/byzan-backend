...
urlpatterns = [
    ...
    path(
        "author/<int:author_id>/", AuthorPostListView.as_view(), name="author-post-list"
    ),
    path(
        "comments/<int:comment_id>/replies/",
        PostCommentReplyCreateView.as_view(),
        name="post-comment-reply",
    ),
    path(
        "id/<int:pk>/comments/",
        PostCommentListCreateByIdView.as_view(),
        name="post-comments-by-id",
    ),
    path("id/<int:pk>/", PostDetailByIdView.as_view(), name="post-detail-by-id"),
    path(
        "<slug:slug>/comments/",
        PostCommentListCreateBySlugView.as_view(),
        name="post-comments",
    ),
